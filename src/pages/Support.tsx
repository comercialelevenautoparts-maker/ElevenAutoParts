  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="container mx-auto px-4 py-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="font-medium">New York City, USA</p>
              </div>
            </div>
          </div>
        </section>
        ...
        {/* FAQ Section */}
        <section>
          <h2 className="text-2xl font-bold mb-2">TEM PERGUNTAS? NÓS TEMOS AS RESPOSTAS.</h2>
          <p className="text-muted-foreground text-sm uppercase tracking-wider mb-6">FAQ</p>
          <p className="text-muted-foreground mb-8 max-w-2xl">
            Na Eleven que sua experiência com autoperças, nosso FAQ cobrem tudo o que você precisa saber para comprar com segurança e rapidez na Eleven Auto Parts.
          </p>
            ...
            {tabs.map((tab) => (
              <button
                ...
                className={`category-tab ${
                  activeTab === tab.toLowerCase() ? 'category-tab-active' : 'category-tab-inactive'
                }`}
              >
                {tab}
              </button>
