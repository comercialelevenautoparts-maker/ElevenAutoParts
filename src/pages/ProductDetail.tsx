        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            {allImages.length > 1 && (
              <div className="grid grid-cols-4 gap-4">
                {allImages.map((img, index) => (
                  <button
                    key={index}
                    className={`bg-muted rounded-lg aspect-square flex items-center justify-center overflow-hidden border-2 ${
          ...
          <div className="space-y-6">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <Button
                variant="outline"
                className="p-4 border-primary text-primary hover:bg-primary/5"
              >
