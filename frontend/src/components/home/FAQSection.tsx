    ...
    <section className="container mx-auto px-4 py-8 lg:py-12 mt-12 lg:mt-0">
      <div className="mb-8 text-left">
        <div className="flex flex-col lg:flex-row lg:items-center gap-1 lg:gap-2 mb-3">
          <span className="section-subtitle text-[10px] md:text-sm lg:order-2">FAQ</span>
          <h2 className="section-title text-[clamp(16px,5vw,24px)] lg:text-4xl lg:order-1">DÚVIDAS FREQUENTES</h2>
        </div>
