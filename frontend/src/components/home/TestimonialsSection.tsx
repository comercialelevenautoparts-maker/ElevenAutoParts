      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-12">
        <div>
          <div className="flex items-center gap-2 mb-2">
            <h2 className="section-title text-[clamp(16px,5vw,24px)] lg:text-4xl">O QUE NOSSOS CLIENTES DIZEM</h2>
        ...
        <a
          ...
          className="btn-primary hidden md:flex items-center gap-1 whitespace-nowrap"
        >
      ...
      {isLoading ? (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {displayedReviews.map((testimonial) => (
            <div key={testimonial.id} className="bg-white dark:bg-muted/50 rounded-2xl p-6 shadow-sm border border-border/50 relative flex flex-col group hover:shadow-md transition-shadow">
