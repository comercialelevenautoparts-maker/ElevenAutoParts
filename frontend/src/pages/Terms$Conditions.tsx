        ...
        <div className="min-h-screen bg-background text-foreground">
            ...
            <main className="container mx-auto px-4 py-8 md:py-12">
                ...
                <section className="mb-8 md:mb-12 text-center">
                    <h1 className="text-2xl md:text-4xl font-bold mb-4">Termos &amp; Condições</h1>
                ...
                <section className="space-y-6 md:space-y-8 prose prose-sm max-w-4xl mx-auto px-2 md:px-0">
                    <h2 className="text-lg md:text-xl font-bold mb-2 md:mb-4">1. Aceitação dos Termos</h2>
                    ...
                    <h2 className="text-lg md:text-xl font-bold mb-2 md:mb-4">2. Modificações</h2>
                    <p className="text-[13px] md:text-base text-muted-foreground leading-relaxed">
                    ...
                    <h2 className="text-lg md:text-xl font-bold mb-2 md:mb-4">3. Uso do Site</h2>
                    <p className="text-[13px] md:text-base text-muted-foreground leading-relaxed">
                    ...
                    <h2 className="text-lg md:text-xl font-bold mb-2 md:mb-4">4. Política de Privacidade</h2>
                    <p className="text-[13px] md:text-base text-muted-foreground leading-relaxed">
                    ...
                    <h2 className="text-lg md:text-xl font-bold mb-2 md:mb-4">5. Responsabilidade</h2>
                    <p className="text-[13px] md:text-base text-muted-foreground leading-relaxed">
                    ...
                    <h2 className="text-lg md:text-xl font-bold mb-2 md:mb-4">6. Lei Aplicável</h2>
                    <p className="text-[13px] md:text-base text-muted-foreground leading-relaxed">
